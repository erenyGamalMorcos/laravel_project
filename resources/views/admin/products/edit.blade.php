                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_name_en" class="form-control" required="" placeholder="{{ __('translations.Product Name En') }}" value="{{ $product->product_name_en }}">
                                </div>
                            </div><!--col 1-->
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_name_ar" class="form-control" required="" placeholder="{{ __('translations.Product Name Ar') }}" value="{{ $product->product_name_ar }}">
                                </div>
                            </div><!--col 1-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="original_price" class="form-control" required="" placeholder="{{ __('translations.Price') }}" value="{{ $product->original_price }}">
                                </div>
                            </div><!--col 1-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="discount_price" class="form-control" required="" placeholder="{{ __('translations.Discount') }}" value="{{ $product->discount_price }}">
                                </div>
                            </div><!--col 1-->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="radio" id="yes" name="in_stock" value="1" @if ($product->in_stock == 1) checked="checked" @endif>
                                    <label for="yes">{{ __('translations.Yes') }}</label><br>
                                    <input type="radio" id="no" name="in_stock" value="0"  @if ($product->in_stock == 0) checked="checked" @endif>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="radio" id="yes" name="status" value="1"  @if ($product->status == 1) checked="checked" @endif>
                                    <label for="yes">{{ __('translations.Yes') }}</label><br>
                                    <input type="radio" id="no" name="status" value="0"  @if ($product->status == 0) checked="checked" @endif>
                                    <label for="no">{{ __('translations.No') }}</label><br>
                                </div>
                            </div><!--col 1-->
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control" required>
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @if ($category->id == $product->category_id) selected="selected" @endif  >{{ (app()->getLocale() == 'en') ? $category->category_name_en : $category->category_name_ar }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="sub_category_id" id="sub_category_id" class="form-control" >
                                        <option value=""  disabled>{{ __('translations.Select Sub Category') }}</option>
                                        <option value="{{ $product->sub_category_id }}" selected="selected" >{{ $sub_category_name }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="sub_sub_category_id" id="sub_sub_category_id" class="form-control" >
                                        <option value=""  disabled>{{ __('translations.Select Sub Category') }}</option>
                                        <option value="{{ $product->sub_sub_category_id }}" selected="selected" >{{ $sub_sub_category_name }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="description_en" class="form-control" placeholder="{{ __('translations.Product Description En') }}"> {{ $product->description_en }}</textarea>
                                </div>
                            </div><!--col 1-->
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="description_ar" class="form-control" placeholder="{{ __('translations.Product Description Ar') }}">{{ $product->description_ar }}</textarea>
                                </div>
                            </div><!--col 1-->
                        </div>
