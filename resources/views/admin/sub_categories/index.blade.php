...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('translations.Sub Categories')  }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('translations.Sub Categories')  }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a class="btn ripple btn-primary" href="{{ route('sub_categories.create',$category_id) }}">{{ __('translations.Add Sub Category') }}</a>
